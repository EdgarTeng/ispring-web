...
<head>
	...
	<script type="text/javascript" src="<s:url value='/resources/js/jstree/jquery.jstree.js'/>"></script>
    	...
    	$(function () {
    		...
    		$("#menuTree").jstree({  
                "json_data" : {
                    "ajax" : {   
                    	"type": "POST",
                        "url" : "<s:url value='/back/getMenuTree'/>"  
                    }
                },  
             "themes" : {  
                 "icons" : false 
...
<body>
	...
	<div class="rounded table">
		...
		<form id="form1" action="<s:url value='/back/saveRoleResource'/>" method="post" onsubmit="">
