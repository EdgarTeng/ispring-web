...
<body>
	...
	<div class="rounded table">
		...
		<form id="form1" action="<s:url value='/back/saveUser'/>" method="post">
		<table class="update" cellpadding="0" cellspacing="1" border="0">
			...
			<tr class="even">
				...
				<td>
					...
					<img title="如果不修改密码，请留空" class="title2div" src="<s:url value='/resources/css/images/operation/help.png'/>" width="16" height="16"/>
				</td>
			...
			<tr class="even">
				...
				<td>
					...
					<img title="只有当用户状态为启用时，用户才能登录" class="title2div" src="<s:url value='/resources/css/images/operation/help.png'/>" width="16" height="16"/>
				</td>
