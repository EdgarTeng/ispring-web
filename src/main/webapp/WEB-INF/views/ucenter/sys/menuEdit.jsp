...
<head>
	...
	<style type="text/css">
		...
		body {
		background: url(<s:url value='/resources/images/gray_bg.png'/>) 0 0 repeat-y #F6F6F6;
		}
	</style>
...
<body>
	...
	<div class="rounded table">
		...
		<form id="form1" action="<s:url value='/back/saveMenu'/>" method="post">
		<table class="update" cellpadding="0" cellspacing="1" border="0">
			...
			<tr class="even">
				...
				<td>
					...
					<img title="目前菜单Code的作用是为了JSP中的显示焦点定位在那个菜单上" class="title2div" src="<s:url value='/resources/css/images/operation/help.png'/>" width="16" height="16"/>
				</td>
			...
			<tr class="even">
				...
				<td>
					...
					<img title="菜单的Url地址" class="title2div" src="<s:url value='/resources/css/images/operation/help.png'/>" width="16" height="16"/>
				</td>
			...
			<tr class="even">
				...
				<td>
					...
					<img title="如果为显示，则会在系统菜单中显示，如果为不显示，则不会出现在导航菜单中，但URL可以授权给角色" class="title2div" src="<s:url value='/resources/css/images/operation/help.png'/>" width="16" height="16"/>
				</td>
