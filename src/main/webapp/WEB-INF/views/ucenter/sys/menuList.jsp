...
<head>
    ...
    function add(){
    	$.jBox("iframe:<s:url value='/back/menuAdd'/>", {
    	    title: "添加菜单",
    	    width: 700,
    	    height: 380,
    	    buttons: {}
    ...
    function edit(id){
    	$.jBox("iframe:<s:url value='/back/menuEdit'/>?id="+id, {
    	    title: "修改菜单",
    	    width: 700,
    	    height: 380,
    	    buttons: {}
    ...
    function delMenu(id,msg){
    	...
    	$.jBox.confirm("确定删除 ["+msg+"] 菜单吗？", "确认操作", function (v, h, f) {
    	    if (v == 'ok'){
    	    	...
    	    	$.post("<s:url value='/back/delMenu'/>",{id:id},function(responseText){
...
<body>
    ...
    <div id="frame_side">
		...
		<jsp:include page="../u_left_menu.jsp"  flush="true">
        	<jsp:param name="current" value="menus"/>
       	</jsp:include>
                    ...
                    <c:choose>
						...
						<td class="operation">
							<a href="javascript:;" onclick="edit(${dataItem.id});">
							 	<img src="<s:url value='/resources/css/images/operation/pencil.png'/>" title="修改菜单信息"/>
							 </a>
							 <a href="javascript:;" onclick="delMenu(${dataItem.id},'${dataItem.menuName}');">
							 	<img src="<s:url value='/resources/css/images/operation/trashcan_delete.png'/>" title="删除菜单"/>
							 </a>
						</td>
