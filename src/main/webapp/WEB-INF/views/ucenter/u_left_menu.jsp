...
<%@page import="com.tenchael.ispring.model.MenuInfo"%>
...
<div id="menu">
	...
	<ol>
		...
		<ul>
			...
			%>
			<li><a href="<s:url value='<%=childMenu.getMenuUrl()%>'/>"
				onfocus="this.blur();"
				<%=childMenu.getMenuCode().equals(current)?" id='current'":""%>><%=childMenu.getMenuName()%></a></li>
			<%
				}
			%>
		</ul>
