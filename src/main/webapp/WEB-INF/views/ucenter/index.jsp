...
<head>
    ...
    <style type="text/css">
        .center_top {
            ...
            padding: 0 0 0 10px;
            font-weight: bold;
            background: url(<s:url value='/resources/images/content_box_bg.gif'/>) #F6F6F6;
            width: 100%;
        }
                ...
                .center .news .row {
                    ...
                    .center .news .row table {
                        ...
                        .center .news .row table td {
                            height: 30px;
                            line-height: 30px;
                            background: url( <s:url value='/resources/images/0101.gif'/> ) repeat-x bottom;
                        }
...
<body>
    ...
    <div id="body_box">
        <table cellpadding="0" cellspacing="0" border="0" class="icon">
            <tr>
                <td>
                <a href="<s:url value='/back/main'/>">
                    <img src="<s:url value='/resources/icon/paper.png'/>" /><br />
                    快捷功能1
                 </a>
                 <a href="<s:url value='/back/main'/>">
                 	<img src="<s:url value='/resources/icon/member.png'/>" /><br />
                 	快捷功能2
                  </a>
                  <a href="<s:url value='/back/main'/>">
                 	<img src="<s:url value='/resources/icon/set_1.png'/>" /><br />
                 	快捷功能3
                  </a>
                   <a href="<s:url value='/back/main'/>">
                 	<img src="<s:url value='/resources/icon/user.png'/>" /><br />
                 	快捷功能4
                  </a>
                 </td>
            </tr>
                               ...
                               <td class="welcome">
                                    <table cellpadding="0" cellspacing="0" border="0" class="server" width="100%">
                                        <tr>
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp; <a href="<s:url value='/back/logout'/>">退出登录</a></td>
                                        </tr>
                                        <tr>
                                            <td>
